...
3. Set pixel size, ink, background, shimmer, breathing, and pointer response.
...
- Timeline duration controls overall animation speed. Drift profile redistributes shimmer speed within a complete seamless forward loop; it is not a stop control.
