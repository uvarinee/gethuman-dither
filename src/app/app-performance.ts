...
const performanceFoundation = defineToolcraftPerformance({
  ...
  rendererTechnique: {
    ...
    performanceRisks: [
      ...
      "Sparse particle positions and velocities live for one mask generation; fixed simulation steps are capped after suspension without changing backing quality.",
